...
/**
 * @ast node
 * @declaredat C:\\Users\\Mark_\\Documents\\EDAN70\\extendj\\java4\\grammar\\Java.ast:278
...
public class DivExpr extends MultiplicativeExpr implements Cloneable {
   ...
   * @declaredat C:\\Users\\Mark_\\Documents\\EDAN70\\extendj\\java4\\frontend\\ConstantExpression.jrag:59
   */
...
protected ASTState.Cycle isConstant_cycle = null;
  ...
  public boolean isConstant() {
    ...
    if (!state.inCircle() || state.calledByLazyAttribute()) {
      ...
      boolean $tmp = getLeftOperand().isConstant()
            && getRightOperand().isConstant()
            && !(getRightOperand().type().isInt() && getRightOperand().constant().intValue() == 0);
   ...
   * @declaredat C:\\Users\\Mark_\\Documents\\EDAN70\\extendj\\java4\\frontend\\PrettyPrintUtil.jrag:363
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
